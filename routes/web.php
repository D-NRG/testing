...
Route::prefix('manufacture')->as('manufacture')->group(function (){
    ...
    Route::get('create', [ManufactureController::class, 'create'])->name('create')->middleware('auth');;
    Route::post('', [ManufactureController::class, 'store'])->name('store')->middleware('auth');;
    Route::get('{manufacture}', [ManufactureController::class, 'show'])->name('show');
    Route::get('{manufacture}/edit', [ManufactureController::class, 'edit'])->name('edit')->middleware('auth');;
    Route::post('edit', [ManufactureController::class, 'editStore'])->name('editStore')->middleware('auth');;
//    Route::put('{category}', [ColorController::class, 'update'])->name('update');
    Route::delete('{manufacture}', [ManufactureController::class, 'delete'])->name('delete')->middleware('auth');;
});
